...
--
-- Client: localhost
-- Généré le: Lun 10 Février 2014 à 06:25
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  `id_auteur` varchar(8) COLLATE utf8_bin NOT NULL,
  `id_parent` varchar(8) COLLATE utf8_bin NOT NULL,
...
INSERT INTO `message` (`id_message`, `content`, `datecreation`, `id_auteur`, `id_parent`) VALUES
(1, 'Bonjour c''est le livreur de pizzas\r\n\r\nVeux-tu un coca ?', '2014-02-09 16:45:04', '1', '1'),
(2, 'J''adore le CSS et le HTML car c''est facile.\r\n\r\nLe reste je galère.', '2014-02-10 02:05:28', '1', '2'),
(3, 'La programmation objet, c''est le mal !', '2014-02-10 01:17:00', '1', '1'),
(4, 'J''hésite entre JS objet et PHP objet.\r\n\r\nFinalement, je préfère la femme objet.', '2014-02-10 02:05:33', '1', '2'),
(5, 'est-ce qu''on dit : 9x3 font 11\r\n\r\nou bien\r\n\r\n9x3 font t-onze ?', '2014-02-10 02:05:17', '1', '3'),
(6, 'J''ai rien à dire, mais bon.', '2014-02-10 01:17:00', '1', '1');
...
INSERT INTO `sujet` (`id_sujet`, `titre`, `description`, `nbrview`, `statut`, `datecreation`, `id_auteur`, `id_parent`) VALUES
...
CREATE TABLE IF NOT EXISTS `theme` (
  ...
  `titre` varchar(32) COLLATE utf8_bin NOT NULL,
  `nbrsujet` int(8) NOT NULL,
  `nbrmsg` int(8) NOT NULL,
  `datecreation` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `id_auteur` varchar(8) COLLATE utf8_bin NOT NULL,
